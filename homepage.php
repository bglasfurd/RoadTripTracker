...
<body>
        <div class="inputbox">
            ...
            <!-- <button class="btn" onclick="edit-locations.php">Edit</button> -->
            <a href="edit-locations.php">
                <button class="edit-location-btn" >Edit Locations</button>
            </a>
